...
const RARITIES = {
  common: { name:'Común', weight:[80,70,60,50,40,32], price:3 },
  uncommon: { name:'Infrecuente', weight:[0,0,0,0,0,0], price:4 },
  rare: { name:'Raro', weight:[20,27,34,38,42,43], price:5 },
  epic: { name:'Épico', weight:[0,3,6,10,14,18], price:7 },
  legendary: { name:'Legendario', weight:[0,0,0,2,4,7], price:10 }
};
...
const creatures = [
  ...
  {id:'silabris',name:'Silabris',emoji:'◈',types:['ortografia','morfologia'],rarity:'common',hp:128,damage:18,cooldown:4.2,ability:{name:'Separación silábica',text:'Da escudo a todo el equipo y acelera a un aliado.',kind:'teamShieldHaste',power:28,status:10}},
  ...
  {id:'puntaluz',name:'Puntaluz',emoji:'¿',types:['ortografia','sintaxis'],rarity:'common',hp:118,damage:20,cooldown:3.6,ability:{name:'Puntuación exacta',text:'Cura y protege al equipo.',kind:'healShield',power:31,status:18}},
  ...
  {id:'conjuro',name:'Conjuro',emoji:'✺',types:['verbos','literatura'],rarity:'common',hp:100,damage:25,cooldown:3.5,ability:{name:'Conjugación encadenada',text:'Lanza dos golpes; el segundo aplica Descarga.',kind:'doubleShock',power:16,status:2}},
  ...
  {id:'gerundra',name:'Gerundra',emoji:'➿',types:['verbos'],rarity:'common',hp:126,damage:16,cooldown:3.1,ability:{name:'Acción continua',text:'Aplica Veneno gramatical de forma acumulativa.',kind:'poison',power:12,status:4}},
  ...
  {id:'sinonix',name:'Sinonix',emoji:'≈',types:['lexico'],rarity:'common',hp:110,damage:17,cooldown:3.9,ability:{name:'Doble sentido',text:'Copia parte del último escudo o cura obtenidos.',kind:'echoSupport',power:24}},
  {id:'antonara',name:'Antonara',emoji:'⇄',types:['lexico'],rarity:'common',hp:106,damage:23,cooldown:3.7,ability:{name:'Contraste',text:'Hace más daño cuanto menos vida tenga tu equipo.',kind:'missingHpDamage',power:21}},
  ...
  {id:'sufijara',name:'Sufijara',emoji:'↤',types:['morfologia'],rarity:'common',hp:102,damage:17,cooldown:3.0,ability:{name:'Final productivo',text:'Cada lanzamiento aumenta el daño de todos los aliados.',kind:'teamRamp',power:8}},
  ...
  {id:'nexora',name:'Nexora',emoji:'∞',types:['sintaxis'],rarity:'common',hp:101,damage:22,cooldown:3.2,ability:{name:'Nexo coordinante',text:'Conecta dos lanzamientos con una Descarga.',kind:'shock',power:20,status:3}},
  ...
  {id:'versalia',name:'Versalia',emoji:'♫',types:['literatura'],rarity:'common',hp:105,damage:19,cooldown:2.8,ability:{name:'Ritmo métrico',text:'Acelera a sus vecinos en el tablero.',kind:'adjacentHaste',power:0,status:16}},
  ...
  {id:'cronoverbo',name:'Cronoverbo',emoji:'⏱',types:['verbos'],rarity:'common',hp:105,damage:22,cooldown:2.7,ability:{name:'Tiempo veloz',text:'Ataca y adelanta su siguiente habilidad.',kind:'selfHasteHit',power:19,status:14}},
  ...
  {id:'morfogolem',name:'Morfogólem',emoji:'⬢',types:['morfologia'],rarity:'common',hp:154,damage:17,cooldown:4.2,ability:{name:'Bloque morfológico',text:'Genera escudo y transforma parte en daño.',kind:'shieldStrike',power:22,status:30}},
  ...
  {id:'lexarca',name:'Lexarca',emoji:'L',types:['lexico'],rarity:'common',hp:112,damage:20,cooldown:3.5,ability:{name:'Eco de significado',text:'Replica parte del último apoyo recibido.',kind:'echoSupport',power:27}},
  ...
  {id:'modulante',name:'Modulante',emoji:'M',types:['verbos','morfologia'],rarity:'common',hp:124,damage:18,cooldown:3.0,ability:{name:'Flexión coral',text:'Cada uso aumenta el daño de todo el equipo.',kind:'teamRamp',power:7}},
  ...
  {id:'prosodian',name:'Prosodian',emoji:'♪',types:['ortografia','literatura'],rarity:'common',hp:100,damage:23,cooldown:2.9,ability:{name:'Cadencia',text:'Acelera a sus aliados cercanos.',kind:'adjacentHaste',power:0,status:17}},
  ...
  {id:'fonemix',name:'Fonemix',emoji:'F',types:['ortografia','lexico'],rarity:'common',hp:102,damage:25,cooldown:3.1,ability:{name:'Eco fonémico',text:'Golpea dos veces y remata con una descarga.',kind:'doubleShock',power:17,status:2}},
