...
values
  ...
  ('word_play', 'Word Play', 'Construye. Combina. Rompe el marcador.', 'Léxico', 'listo', 11, '#22d3ee', '🔠', 'https://pablogarciablancov.github.io/lenguarcade/games/word_play/', 'board', true, 'Roguelike de palabras con cartas, tienda, mejoras, misiones lingüísticas, fichas especiales, combos y progresión léxica.', 'léxico,vocabulario,ortografía,acentuación,estrategia', 'embedded', true, now())
