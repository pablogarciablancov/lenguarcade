...
values
  ...
  ('versopolis', 'Versópolis', 'La ciudad de la poesía', 'Poesía', 'en pruebas', 4, '#8b5cf6', '✒️', 'https://pablogarciablancov.github.io/lenguarcade/games/versopolis/', 'versopolis-banner.webp', true, 'Duelo poético por rondas: reconoce rimas, métrica y recursos expresivos para conquistar Versópolis.', 'poesía,rima,métrica,creatividad', 'embedded', true, now()),
  ...
  ('tierras_de_tinta', 'Tierras de Tinta', 'Cada palabra es un arma', 'RPG de acción', 'en pruebas', 12, '#e9a23b', '🖋️', 'https://pablogarciablancov.github.io/lenguarcade/games/tierras_de_tinta/', 'tierras-de-tinta-banner.webp', true, 'RPG de acción y exploración: supera expediciones, derrota criaturas y mejora tu héroe resolviendo desafíos de Lengua.', 'ortografía,morfología,verbos,semántica,literatura,comprensión', 'embedded', true, now()),
  ('lexaria', 'Lexaria', 'Academia de criaturas lingüísticas', 'Estrategia', 'en pruebas', 13, '#4f8cff', '✦', 'https://pablogarciablancov.github.io/lenguarcade/games/lexaria/', 'lexaria-banner.webp', true, 'Auto-battler educativo: colecciona Lexarios, entrena con retos de Lengua, crea sinergias y combate en la Academia.', 'lengua,léxico,verbos,literatura,estrategia', 'embedded', true, now())
