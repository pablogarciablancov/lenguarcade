...
values
  ...
  ('word_play', 'Word Play', 'Construye. Combina. Rompe el marcador.', 'Léxico', 'en pruebas', 11, '#22d3ee', '🔠', 'https://pablogarciablancov.github.io/lenguarcade/games/word_play/', 'board', true, 'Roguelike de palabras con cartas, mejoras, retos lingüísticos, combos y progresión léxica.', 'léxico,vocabulario,ortografía,acentuación,estrategia', 'embedded', false, now())
